...
import safers.rooftops.courses.Course;
import safers.rooftops.courses.Obstacle;
import safers.rooftops.courses.RooftopCourseAlKharid;
import safers.rooftops.courses.RooftopCourseArdougne;
import safers.rooftops.courses.RooftopCourseCanifis;
import safers.rooftops.courses.RooftopCourseDraynor;
import safers.rooftops.courses.RooftopCourseFalador;
import safers.rooftops.courses.RooftopCoursePollnivneach;
...
public class RooftopsCourseManager {
    ...
    public void onGameTick(final GameTick ignored) {
        ...
        // Update the current course and obstacle based on the player's location
        if (course != null) {
            WorldPoint playerLocation = client.getLocalPlayer().getWorldLocation();
            course.updateCurrentObstacle(playerLocation);
        }
    ...
    private boolean isNearObstacle() {
        ...
        for (final WorldPoint obstacle_point : course.getNextObstacle().getLocations()) {
